...
const AppointmentDetails = ({ appointment }) => {
    ...
    return (
        <div className="appointment-details">
            ...
            <p><strong>Date of Birth: </strong>{appointment.date_of_appt && new Date(appointment.date_of_appt).toLocaleDateString()}</p>
            <p><strong>Department: </strong>{appointment.department}</p>
            <p><strong>Date of Appointment: </strong>{appointment.date_of_appt && new Date(appointment.date_of_appt).toLocaleDateString()}</p>
